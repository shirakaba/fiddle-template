...
} = require('@expo/config-plugins/build/plugins/createBaseMod');
...
function createPlatformBaseMod(platform, providers) {
  // TODO: check whether we can use createPlatformBaseMod() as-is nowadays or
  // whether we really do need to make this platformProviders
